...
public class BounceEthernetPortWorkItemHandler implements WorkItemHandler{
    ...
    public BounceEthernetPortWorkItemHandler(KieSession kieSession) {
    ...
    public void executeWorkItem(WorkItem workItem,
		...
		final String methodName = " BounceEthernetPortWorkItemHandler.executeWorkItem() ";
		LOG.info(methodName);
		...
		mockEthernetBouncePort(processMock);
		
		String bouncePortStatus = mockService.mockEthernetBouncePort(processMock);
		if(bouncePortStatus==null){
			bouncePortStatus="Error";
		}
        System.out.println("bouncePortStatus - " + bouncePortStatus);*/
        
        Map<String, Object> outputParams = new HashMap<String, Object>();
        outputParams.put("bouncePortStatus", "OK");
    ...
    /*private void mockEthernetBouncePort(String processMock) {
    	when(mockService.mockEthernetBouncePort(Matchers.contains("BOU"))).thenReturn("OK");
    	//when(mockService.rebootOnt(Matchers.contains("NBOU"))).thenReturn(false);
    }*/
}
